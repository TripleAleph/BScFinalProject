 ...
 * Use the [Article1Fragment.newInstance] factory method to
...
class Article1Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val webView = view.findViewById<WebView>(R.id.article1WebView)
...
//        button back to the main screen
    ...
    companion object {
         ...
         * @return A new instance of fragment Article1Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Article1Fragment().apply {
